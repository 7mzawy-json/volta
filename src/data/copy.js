export const copy = {
  ar: {
    ...
    build: {
      title: 'شلون انبنى هالموقع',
      lede: 'كل رقم بهالقسم محسوب من الموقع نفسه، مو مكتوب باليد.',
      demo: {
        label: 'في شريط البحث',
        sentence: 'أبي تلفون شاشته كبيرة بأقل من {n} دينار، والأرخص أول',
        caption: 'هذا مثال جاهز. اكتب جملتك إنت بشريط البحث فوق، ونموذج لغوي يحوّلها لفلاتر مثل هذي.',
        under: 'أقل من {price}',
        cheapest: 'الأرخص أول',
        cta: 'شوف النتائج'
      },
      stats: {
        variants: { label: 'خيار للشراء', note: 'موزّعة على {n} منتج، وكل جهاز بصفحة وحدة' },
        routes: { label: 'صفحة لها معاينة', note: 'تتجهّز وقت البناء، عشان الروابط ومحركات البحث' },
        currencies: { label: 'عملة', note: '{n} منها بثلاث خانات عشرية، مو ثنتين' },
        weight: { unit: 'كيلوبايت', label: 'وزن هذي الصفحة', note: 'انقاس من متصفحك الحين' }
      },
      stack: {
    ...
    closing: {
      title: 'جاهز تبدأ؟',
      subtitle: 'أسرع طريقة تشتري فيها هاتفك الجديد بالكويت.',
      cta: 'تصفح الهواتف'
    },
    categories: {
    ...
    search: {
      reading: 'نقرأ سؤالك…',
      readThis: 'حوّل هالجملة لفلاتر',
      understoodAs: 'حوّلنا «{q}» للفلاتر اللي تحت.',
      searchInstead: 'ابحث بالكلمات بدالها'
    },
    filters: {
      all: 'الكل',
      sortLabel: 'ترتيب حسب',
    ...
    cart: {
      title: 'سلة التسوق',
      empty: 'سلتك فاضية. لا تخليها كذا!',
    ...
    checkout: {
      ...
      street: 'شارع',
      building: 'منزل / عمارة',
      details: 'الدور أو الشقة (اختياري)',
      phone: 'رقم الهاتف',
      orderSummary: 'ملخص الطلب',
      demoNotice: 'الدفع يمر فعلًا عبر Stripe بالوضع التجريبي: العملية حقيقية، بس ما ينسحب أي مبلغ.'
    },
    wishlist: {
      empty: 'ما حفظت شي بالمفضلة للحين.'
    },
    misc: {
    ...
    account: {
      ...
      signInLead: 'عشان تكتب تقييم وتتابع طلباتك.',
      signUpLead: 'حساب واحد يكفي للتقييمات والطلبات.',
    ...
    profile: {
      title: 'حسابي',
      lead: 'بياناتك وعنوان التوصيل وكلمة المرور، كلها هني.',
      detailsTitle: 'بياناتي',
      addressTitle: 'عنوان التوصيل',
      addressLead: 'نستخدمه لتعبئة صفحة الدفع تلقائيًا. تقدر تغيّره وقت الشراء.',
      addressEmpty: 'ما عندك عنوان محفوظ.',
      ...
      save: 'حفظ',
      saved: 'تم الحفظ.',
      removeAddress: 'احذف العنوان',
      addressRemoved: 'تم حذف العنوان.',
      dangerTitle: 'حذف الحساب',
      dangerLead: 'يحذف حسابك وتقييماتك وطلباتك نهائيًا، وما تقدر تتراجع بعدها.',
      deleteAccount: 'احذف حسابي',
      deleteConfirm: 'أكّد بكلمة المرور عشان نحذف الحساب.',
      deleteCta: 'أعرف وأبي أحذف',
      keepAccount: 'تراجع',
      deleted: 'انحذف حسابك. مع السلامة.',
      memberSince: 'عضو منذ'
    },
    reviews: {
      title: 'التقييمات',
      empty: 'ما في تقييمات للحين. خلك أول واحد!',
      write: 'اكتب تقييمك',
      yours: 'تقييمك',
      edit: 'تعديل',
      remove: 'حذف',
      ...
      rating: 'التقييم',
      body: 'رأيك',
      bodyPlaceholder: 'شلون كانت تجربتك مع الجهاز؟',
      publish: 'انشر التقييم',
      signInPrompt: 'سجّل دخولك عشان تكتب تقييم.',
      confirmDelete: 'تحذف تقييمك؟',
      outOf: 'من ٥',
      // Arabic has six plural categories; only the ones Intl.PluralRules can
      // select for Arabic are listed. See §4 — this asymmetry is deliberate.
      count: {
        zero: 'لا تقييمات',
        one: 'تقييم واحد',
        two: 'تقييمان',
    ...
    orders: {
      title: 'طلباتي',
      empty: 'ما عندك طلبات للحين.',
      browse: 'تصفح المنتجات',
      statusPending: 'بانتظار الدفع',
      statusPaid: 'مدفوع',
      statusFailed: 'ما تم الدفع',
      total: 'الإجمالي',
      placed: 'بتاريخ',
      view: 'التفاصيل',
      back: 'رجوع لطلباتي',
      waiting: 'ننتظر تأكيد الدفع…',
      waitingNote: 'الصفحة تتحدث تلقائيًا، ما تحتاج تسوي تحديث.',
      justPaid: 'تم الدفع. شكرًا!',
    ...
    pay: {
      ...
      chargedIn: 'الخصم يصير بعملة {currency}، لأن مزوّد الدفع ما يدعم الدينار الكويتي.',
      redirecting: 'نحوّلك للدفع…',
      signInFirst: 'سجّل دخولك عشان تكمل الدفع. عنوانك محفوظ لين ترجع.',
      signInAndPay: 'سجّل دخولك وأكمل الدفع'
    },
    apiErrors: {
      invalidCredentials: 'البريد أو كلمة المرور غير صحيحة.',
      emailTaken: 'هذا البريد مسجّل من قبل.',
      passwordTooShort: 'كلمة المرور لازم تكون ثمانية أحرف على الأقل.',
      passwordTooLong: 'كلمة المرور طويلة زيادة.',
      missingFields: 'عبّي كل الخانات.',
      tooManyAttempts: 'محاولات كثيرة. جرّب بعد شوي.',
      aiUnavailable: 'ما قدرنا نقرأ سؤالك الحين، فبحثنا لك بالكلمات.',
      aiNotConfigured: 'قراءة الأسئلة مو مفعّلة، فبحثنا لك بالكلمات.',
      notAuthenticated: 'لازم تسجّل دخول أول.',
      notYours: 'هذي مو بياناتك.',
      currentPasswordWrong: 'كلمة المرور الحالية غير صحيحة.',
      invalidAddress: 'راجع خانات العنوان.',
      nameTooShort: 'الاسم قصير زيادة.',
      notFound: 'ما لقيناه.',
      alreadyReviewed: 'كتبت تقييم لهذا المنتج من قبل.',
      invalidRating: 'اختر تقييم من ١ إلى ٥.',
      reviewTooShort: 'اكتب شوي زيادة.',
      emptyCart: 'سلتك فاضية.',
      insufficientStock: 'الكمية المطلوبة مو متوفرة.',
      paymentsNotConfigured: 'الدفع مو مفعّل حاليًا.',
      networkUnreachable: 'ما قدرنا نوصل للخادم. إذا هذي أول زيارة من فترة، يمكن الخادم نايم. جرّب بعد دقيقة.',
      serverError: 'صار خطأ عندنا. جرّب مرة ثانية.'
    },
    currency: {
      title: 'العملة',
      ...
      note: 'أسعار تقريبية للاطلاع بس. الطلب ينحسب بالدينار الكويتي، والخصم يصير بعملة يدعمها مزوّد الدفع.',
    ...
    compare: {
      ...
      clear: 'مسح',
      remove: 'إزالة',
      empty: 'ما اخترت أي هاتف للمقارنة. اختر هاتفين على الأقل من صفحة المنتجات.',
      browse: 'تصفح الهواتف',
      attribute: 'الخاصية',
      best: 'الأفضل في هذا الصف',
      legend: 'الصفوف الباهتة متطابقة بين كل الأجهزة. الأرقام الملوّنة هي الأفضل في صفها.',
      legendDiff: 'يعرض الصفوف التي تختلف فيها الأجهزة فقط. الأرقام الملوّنة هي الأفضل في صفها.',
      region: 'جدول المقارنة، يتمرر أفقيًا',
      prev: 'الهاتف السابق',
      next: 'الهاتف التالي',
      positionOf: 'الهاتف {n} من {total}',
      differencesOnly: 'الاختلافات فقط',
      noDifferences: 'كل الصفوف المعروضة متطابقة بين هذي الأجهزة.',
      rows: {
        price: 'السعر',
        brand: 'الماركة',
        screen: 'الشاشة',
    ...
    meta: {
      ...
      checkout: 'أدخل عنوان التوصيل في الكويت وادفع عبر Stripe في الوضع التجريبي دون سحب أي مبلغ حقيقي.',
      ...
      signup: 'أنشئ حساب فولتا لمتابعة طلباتك وكتابة تقييماتك.',
      orders: 'طلباتك السابقة وحالة الدفع لكل واحد منها.',
      profile: 'عدّل بياناتك وعنوان التوصيل وكلمة المرور في فولتا.',
    ...
    footer: {
      ...
      demo: 'مشروع جامعي بواجهة وخادم وقاعدة بيانات حقيقية، والدفع عبر Stripe بالوضع التجريبي، يعني ما ينسحب أي مبلغ حقيقي.'
    }
  },
  en: {
    brand: 'VOLTA',
    ...
    account: {
      ...
      signInLead: 'To write a review and follow your orders.',
      signUpLead: 'One account covers reviews and orders.',
      email: 'Email',
      name: 'Name',
      password: 'Password',
    ...
    profile: {
      ...
      addressEmpty: 'No address saved yet.',
      ...
      dangerLead: 'Deletes your account, your reviews and your orders for good. This cannot be undone.',
      deleteAccount: 'Delete my account',
      deleteConfirm: 'Confirm with your password to delete the account.',
      deleteCta: 'I understand, delete it',
    ...
    reviews: {
      ...
      rating: 'Rating',
      body: 'Your thoughts',
      bodyPlaceholder: 'How has the device been to live with?',
      publish: 'Publish review',
      signInPrompt: 'Log in to write a review.',
    ...
    apiErrors: {
      ...
      invalidAddress: 'Please check the address fields.',
      nameTooShort: 'That name is too short.',
      notFound: 'Not found.',
      alreadyReviewed: 'You have already reviewed this product.',
      invalidRating: 'Pick a rating from 1 to 5.',
      reviewTooShort: 'A little more, please.',
    ...
    compare: {
      ...
      noDifferences: 'Every row shown is identical across these phones.',
      rows: {
        price: 'Price',
        brand: 'Brand',
        screen: 'Screen',
    ...
    meta: {
      ...
      signup: 'Create a VOLTA account to follow your orders and write reviews.',
      orders: 'Your past orders and the payment status of each.',
      profile: 'Edit your VOLTA details, delivery address and password.',
